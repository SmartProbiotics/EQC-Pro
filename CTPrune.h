...
namespace CTPrune {
	...
	void truss_peeling(ui n, ui triangle_threshold, ui *Qe, ui *tri_cnt, ept *edges_pointer, char *deleted, ui *degree, ept *pstart, ept *pend, ui *edges) {
		ept Qe_n = 0;
	...
	void truss_pruning(ui &n, ept &m, ui triangle_threshold, ui *peel_sequence, ui *out_mapping, ui *rid, ept *pstart, ui *edges, ui *degree, bool output) {
		...
		truss_peeling(n, triangle_threshold, Qe, tri_cnt, edges_pointer, deleted, degree, pstart, pend, edges);
